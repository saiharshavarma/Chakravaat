    ...
    <div className="flex flex-row w-full">
      ...
      <div className="flex items-center rounded-lg h-16 mt-6 py-6 pl-4 w-full bg-white bg-opacity-10">
        ...
        <Tooltip title={"Change Intensity Unit To " + getNextWindUnit()}>
          <button
            className="w-full text-sm h-10 bg-white bg-opacity-10 rounded-lg mr-3 hover:bg-opacity-100 transition ease-in-out delay-150 text-white hover:text-zinc-950"
